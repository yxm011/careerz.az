      ...
      },
      {
        ...
        steps: [
            ...
            blocks: [
          {
            ...
            type: 'richText',
            data: {
              content: `<h2>Task 3: Presenting Your Insights</h2>
              <p>Great work! Now it's time to present your findings to the team. Rashad wants to understand the user journey issues you've identified.</p>
              <h3>User Journey Insights</h3>
              <p>Based on your analysis, you've identified several key insights:</p>
              <ul>
                <li>The bill payment feature has an 80% completion rate, but 13% drop off at confirmation</li>
                <li>Young users (18-25) are the most engaged, using card transfers frequently</li>
                <li>Older users (51+) have the lowest engagement at 16% DAU</li>
                <li>The 36-50 age group represents 30% of users but only 32% daily engagement</li>
              </ul>`
            }
          },
          {
            id: 'task-3-prioritization',
            type: 'ordering',
            data: {
              question: 'Prioritize these improvements based on potential impact (1 = highest priority):',
              items: [
                { id: '1', text: 'Simplify the bill payment confirmation screen to reduce drop-offs' },
                { id: '2', text: 'Create a simplified interface mode for 51+ users' },
                { id: '3', text: 'Add more card-to-card transfer options for young users' },
                { id: '4', text: 'Improve onboarding tutorials for new features' }
              ],
              hint: 'Consider which changes will impact the most users and solve the biggest problems'
            }
          },
          {
            id: 'final-reflection',
            type: 'textInput',
            data: {
              label: 'Final Reflection: What was the most important insight you gained from analyzing ABB Bank\'s digital banking data?',
              placeholder: 'Reflect on what you learned about data analysis, customer behavior, or digital banking...',
              required: true
            }
          },
          {
            ...
            data: {
              ...
              <p>You've completed the Digital Banking Analyst simulation at ABB Bank!</p>
              <h3>Skills You've Developed:</h3>
              <ul>
                <li><strong>Data Analysis:</strong> Calculated conversion rates and analyzed user behavior patterns</li>
                <li><strong>Customer Segmentation:</strong> Understood how different age groups use digital banking</li>
                <li><strong>Problem Identification:</strong> Identified drop-off points and engagement issues</li>
                <li><strong>Strategic Thinking:</strong> Made data-driven recommendations for product improvements</li>
                <li><strong>Communication:</strong> Presented insights in a clear, actionable way</li>
              </ul>
              <p>These analytical and strategic skills are essential for any role in digital banking, fintech, or product management. You're now ready to tackle real-world digital banking challenges!</p>`
            }
          }
        ]
      }
